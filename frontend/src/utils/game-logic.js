...
export const RUNNING_STYLES = {
  大逃げ:   { early: 1.68, middle: 1.38, late: 0.47, description: '序盤から全力。終盤でバテる' },
  逃げ:     { early: 0.85, middle: 0.98, late: 1.18, description: '先頭を走りながらスタミナ温存' },
  先行:     { early: 0.78, middle: 1.00, late: 1.15, description: '先団に位置し粘り強く走る' },
  差し:     { early: 0.87, middle: 1.04, late: 1.00, description: '中団で足をため終盤に加速' },
  追込:     { early: 0.80, middle: 0.85, late: 1.45, description: '後方待機から直線で追い込む' },
