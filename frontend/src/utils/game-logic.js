...
const HORSE_POOL = [
  ...
  { name: 'スプリンターズS歴代', speed: 'S', stamina: 'D', stability: 'B', burst: 'S', turfFit: 'S', dirtFit: 'B', distanceFit: 'short', runningStyle: '逃げ' },
  ...
  { name: 'タピット産駒代表', speed: 'S', stamina: 'S', stability: 'A', burst: 'S', turfFit: 'C', dirtFit: 'SS', distanceFit: 'mile', runningStyle: '先行' },
  ...
  { name: 'ワールドプレミア候補', speed: 'S', stamina: 'SSS', stability: 'S', burst: 'S', turfFit: 'SS', dirtFit: 'C', distanceFit: 'long', runningStyle: '差し' },
