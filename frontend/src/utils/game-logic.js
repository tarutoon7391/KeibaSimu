...
export const RUNNING_STYLES = {
  ...
  逃げ:     { early: 0.75, middle: 0.90, late: 1.18, description: '先頭を走りながらスタミナ温存' },
  先行:     { early: 0.76, middle: 0.99, late: 1.15, description: '先団に位置し粘り強く走る' },
  差し:     { early: 0.85, middle: 1.03, late: 1.00, description: '中団で足をため終盤に加速' },
  追込:     { early: 0.79, middle: 0.84, late: 1.45, description: '後方待機から直線で追い込む' },
  直線一気: { early: 0.78, middle: 0.75, late: 1.97, description: '直線のみで勝負する大博打' },
  まくり:   { early: 0.82, middle: 1.62, late: 0.73, description: '3コーナーから一気に進出' },
};
